...
@Component({
  selector: 'app-algodao.chinese',
  standalone: true,
  imports: [
    MatCardModule, 
    ForDirective, 
    AlgodaoChineseComponent,
   RouterModule,
    SlickCarouselModule,
    CommonModule
  ],
  templateUrl: './algodao.chinese.component.html',
  styleUrl: './algodao.chinese.component.css',
  
})
export class AlgodaoChineseComponent implements OnInit{
  ...
  slides = [
    {img: "/carousel/browser/assets/images/algodao.jpg",title: "SSSSSS",routeUrl: "CCCCCCCCCC"},
