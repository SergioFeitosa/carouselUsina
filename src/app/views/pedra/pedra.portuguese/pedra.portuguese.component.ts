...
export class PedraPortugueseComponent {
  ...
  slides = [
    {img: "/carousel/browser/assets/images/diamante.jpg",title: "Diamante",routeUrl: "diamante/portuguese"},
    {img: "/carousel/browser/assets/images/esmeralda.jpg",title: "Esmeralda",routeUrl: "esmeralda/portuguese"},
  ]
